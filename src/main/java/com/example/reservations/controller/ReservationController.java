...
public class ReservationController {
    ...
    public Flux<ReservationEvent> streamReservations() {
        ...
        ReservationEvent r5 = new ReservationEvent(
                ...
                List.of("anthony.quishpe@example.com"));

        ReservationEvent defaultReservation = new ReservationEvent(
                "RES-000", "Reserva Genérica", 0.0, List.of());
